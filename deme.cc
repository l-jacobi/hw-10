...
const Chromosome* Deme::get_best() const{
	...
	if(pop_.size() > 1){
		...
		for(int i = 1; i < pop_.size(); ++i){	//is it faster to assign pop_.size() to a variable so i don't have to access it like this? i checked the implementation for vectors and it's calculated by subtraction of the begin and end iterators
